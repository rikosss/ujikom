    ...
    <tbody>
      ...
      ?>
          <tr align="center">
            ...
            <td align="center">
              <div>
                <a href="pegfarmasiedit.php?idFarmasi=<?= $row['id_farmasi'] ?>" class="btn btn-xs btn-warning" title="Edit" onclick="return confirm('Apakah anda yakin ingin Mengubah?')">
